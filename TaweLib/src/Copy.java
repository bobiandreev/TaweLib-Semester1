...
public class Copy implements Serializable {
    ...
    /**
     * Getter method of the next day date.
     * 
     ...
     * 
     * @param dateRequestReturn The date a User has requested to return this
     *                          copy.
     */
    ...
    /**
     * Setter method of the borrowing history of a copy. This saves the time it
     * was returned.
     */
     ...
     * user to request.
     * 
     * @param item The resource for which the user checks if there is a free
     *             copy.
    ...
    /**
     * Setter method of isReserved.
     * 
     * @param isReserved True if is reserved, false otherwise.
     */
    ...
    /**
     * ToString method representing the current copy of a resource.
     */
    @Override
    ...
    /**
     * Second toString method that give the due date of an item.
     * 
     * @return The due date of an item, if there is one.
     */
