...
public class Draw extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        buttons.getChildren().addAll(pencilbutton, eraserbutton, linebutton, rectanglebutton, circlebutton,
                line_colour, colourpickerLine, fill_colour, colourpickerFill, line_width, slide, open, save);
        ...
        sketchpad.setOnMousePressed(e->{
            if(pencilbutton.isSelected()) {
                ...
                rectangle.setX(e.getX()); rectangle.setY(e.getY());               
        ...
        sketchpad.setOnMouseReleased(e->{
            if(pencilbutton.isSelected()) {
                ...
                gc.strokeLine(straightline.getStartX(), straightline.getStartY(), straightline.getEndX(), straightline.getEndY());
        ...
        save.setOnAction((e)->{
            ...
            if (file != null) {
                try {
                    ...
                    ImageIO.write(rendImg, "png", file);
