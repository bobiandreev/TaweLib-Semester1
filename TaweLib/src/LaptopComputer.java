...
public class LaptopComputer extends Resource {
     ...
     * 
     * @param title          Name of computer.
     * @param year           Year of manufacture
     * @param thumbnailImage Picture of the laptop
     * @param numOfCopies    Total available computers in the library
     * @param manufacturer   Manufacturer of the computer
     * @param model          Model of the computer
     * @param OS             Operating system running on the laptop
     */
    ...
    /**
     * Setter method for laptop's manufacturer.
     * 
    ...
    /**
     * Setter method for laptop's model.
     * 
