...
public class ProfileImage {
	 ...
	 *            String that sets the name of the image
	 * @param image
	 *            File to be used as a profile image
	 * @param avatars
	 *            Array holding the profile images
	 */
	 ...
	 * 
	 * @param in
	 *            scanner that sets the image name
	 * 
	 */
	 ...
	 * 
	 * @param file
	 *            File to which the information should be written
	 * @throws IOException
	 *             Exception thrown if the file doesnt exist
	 */
