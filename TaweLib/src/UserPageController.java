...
public class UserPageController {
    ...
    @FXML
    private void clickOnBorrowedItems(ActionEvent event) { // Jump to the BorrowedItems Page after the user click the button 
    	try {
    ...
    @FXML
    private void clickOnRequestedItems(ActionEvent event) { // Jump to the Requested Items Page after the user click the button 
    	try {
