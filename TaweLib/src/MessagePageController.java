...
/**
 * <h1> Message Pane Controller class for the GUI. </h1>
 * The MessagePaneController class controls the MessagePage.fxml
 * 
 * @author Ming
 * @version 1.0
 * @since 2018-12-05
...
public class MessagePageController {
    ...
    /**
     * Obtains all all user messages accordingly and stores them into log/messageList. 
     */
