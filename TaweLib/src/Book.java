...
public class Book extends Resource {
     ...
     * @param year        Year when book was released.
     * @param image       Cover image of the book.
     * @param numOfCopies Number of copies for the book.
     ...
     * 
     * @param genre String that holds the genre of the book
     */
     ...
     * 
     * @param ISBN String that holds the book ISBN
     */
     ...
     * 
     * @param language String that holds language of the book
     */
