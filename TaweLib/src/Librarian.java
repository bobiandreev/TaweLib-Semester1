...
public class Librarian extends User {
	...
	if (curUser.getBalance() == 0) {
		...
		if (curCopy != null) {
		    ...
		    alert1.setContentText(
			    "There were no free copies at the moment. "
				    + "You have been added"
				    + "to the waiting list and a copy has been "
				    + "reserved for you. You will receive a message"
				    + " when a copy is free.");
		    alert1.showAndWait();
		}
	    } else {
    ...
    /**
     * Method to approve or not whether a user is going to borrow or not.
     * 
     * @param flag    True if approved, false otherwise.
     * @param curCopy the copy to be borrowed.
     */
    ...
    /**
     * Method to approve or not whether a user is going to return his copy or
     * not.
     * 
     * @param flag    True if approved, false otherwise.
     * @param curCopy the copy to be returned.
     */
