...
public class ChooseCreateTypePageController {
    ...
    /**
     * Appropriate actions will be carried out when button is clicked. The
     * creation of a new book resource will occur.
     * 
     * @param event
     */
    @FXML
    ...
    /**
     * Appropriate actions will be carried out when button is clicked. The
     * creation of a new DVD resource will occur.
     * 
     * @param event
     */
    @FXML
    ...
    /**
     * Appropriate actions will be carried out when button is clicked. The
     * creation of a new Laptop resource will occur.
     * 
     * @param event
     */
    @FXML
