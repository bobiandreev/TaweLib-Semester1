...
public class Fine {
    ...
    /**
     * Getter method of the days overdue.
     * 
     * @return The totals days overdue.
     */
    ...
    /**
     * Method being used to find the difference between the two dates.
     * 
     * @param dueDate     The due date of that copy.
     * @param currentDate The current date.
     * @return The total days the have in difference.
     */
    ...
    /**
     * Method that checks if the user has borrowed the copy for the at least the
     * time he should have.
     * 
     * @param copy The copy the user has borrowed.
     * @return The date he should return it.
     */
